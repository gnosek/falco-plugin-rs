...
falco_event_schema::derive_deftly_for_enums! {
    impl<'de> Deserialize<'de> for TaggedRepr<falco_event_schema::fields::types::$ttype> {
        fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
            let val = falco_event_schema::fields::types::$ttype::new(Deserialize::deserialize(deserializer)?);
            Ok(Self {
...
falco_event_schema::derive_deftly_for_bitflags! {
    impl<'de> Deserialize<'de> for TaggedRepr<falco_event_schema::fields::types::$ttype> {
        ...
        where
            D: Deserializer<'de>,
        {
            let val = falco_event_schema::fields::types::$ttype::from_bits_retain(Deserialize::deserialize(deserializer)?);
            Ok(Self {
